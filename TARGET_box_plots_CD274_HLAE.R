...
output_dir <- "/home/sergio/Scrivania/gmNK/TARGET_analysis/boxplot_expression_CD274_HLAE"
dir.create(output_dir, showWarnings = FALSE, recursive = TRUE)

# Target genes
target_genes <- c("CD274", "HLA-E")

# Read TPM from a single sample file
...
if (nrow(expression_data) == 0) stop("No data collected.")

# Extended color palette (Pastel + soft Viridis-like style)
...
plot_gene_boxplot <- function(data, gene_name) {
  ...
  # Order tumors by median expression
