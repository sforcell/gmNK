...
output_dir <- "/home/sergio/Scrivania/gmNK/TCGA_analysis/immunotype_results_ligands_before_tumor_contact"
...
# Ligands of markers upregulated in gmNK
extra_genes <- c(
