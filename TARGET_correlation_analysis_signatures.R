...
# Function to compute signature score
...
for (tumor in tumors) {
  ...
  # Immune classification (hot / intermediate / cold)
...
if (length(correlation_list) > 0) {
  ...
  cat("Heatmap saved in:", file.path(output_dir, "TARGET_heatmap_correlations.pdf"), "\n")
}
