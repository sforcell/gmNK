...
output_dir <- "/home/sergio/Scrivania/gmNK/TCGA_analysis/immunotype_results_ligands_after_tumor_contact"
...
ligand_genes <- c( 
  ...
  "CXCL12",    # SDF-1, substrate cleaved by CD26
  ...
  "CD177",     # Direct ligand of CD31 (neutrophils, tumors)
  "ENG",       # Endoglin, interacts with PECAM1 in angiogenesis
  "ITGAV",     # Integrin αv (indirect/functional interaction)
  "ITGB3",     # Integrin β3
  ...
  "CD300A"     # Interaction reported with PTPRJ
)
...
for (tumor in tumors) {
  ...
  # Immune score based on CD8A and IFNG (simplified or custom set)
